import type { WorkData } from '../components/work'

export const morphKeysData = {
  links: [
    [
      'ITmedia NEWS',
  ...
  publications: [
    ...
    [
      <>
        ...
        入江 英嗣. "MorphKeys: スイッチ付きNFCタグを用いた形状自在キーボード",
        第33回インタラクティブシステムとソフトウェアに関するワークショップ (WISS
        2025), Dec 2025. (国際学会招待発表)
      </>,
    ],
    [
      <>
